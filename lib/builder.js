...
buildClient = function(config, options, extra, next) {
  var APPLICATION_PATH, PUBLIC_PATH, bwatcher, command, dstpath, indexPath, ref, ref1, ref2, srcpath, type, watcher;
  ref = options._c.paths, APPLICATION_PATH = ref.APPLICATION_PATH, PUBLIC_PATH = ref.PUBLIC_PATH;
  if (extra.watcher) {
    watcher = extra.watcher, bwatcher = extra.bwatcher;
