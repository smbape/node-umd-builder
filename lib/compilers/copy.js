var CopyCompiler, _, _copyFile, builder, copyFile, copySem, fns, fs, hasProp, log4js, logger, mkdirp, semLib, sysPath, wait;
...
copyFile = function(dst, src, plugin, done) {
  ...
  if (hasProp.call(fns, dst)) {
    ...
    fn = fns[dst] = _.throttle(_copyFile.bind(null, dst), wait, {
      leading: false,
      trailling: false
    });
  }
