...
module.exports = AmdCompiler = (function() {
  ...
  AmdCompiler.prototype._processPackages = function(plugin, name) {
    var __deepackName, __packageName, _dirname, _module, _packageName, absPath, basename, content, deps, dirname, hasChanged, hasFile, i, j, k, key, lastIndex, lastPackages, lastPackagesKey, len, len1, match, obj, packageName, packages, path, paths, ref1, ref2, reg, relModulePath, relpath, status;
